...
wrongdataFetch
    .then(response => {
      if(!response.ok){   //this condition will check if there is any error while fetching url. If there is no error it will go to return (response.json). 
    ...
    .catch((error)=>{ //hadles promiseRejection
